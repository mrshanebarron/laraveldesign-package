...
@section('title', config('laraveldesign.blog_title', 'Blog'))

@section(config('laraveldesign.content_section', 'content'))
<div class="mb-12">
    <h1 class="text-3xl md:text-4xl font-serif font-bold mb-2">{{ config('laraveldesign.blog_title', 'Blog') }}</h1>
    <p class="text-gray-500">Latest posts and updates</p>
</div>
